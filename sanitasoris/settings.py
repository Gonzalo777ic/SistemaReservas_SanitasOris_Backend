"""
Django settings for sanitasoris project.
...
SECRET_KEY = "django-insecure-51aqsu$#a=8k8n7nr(gw&u!$*oh8*qw%1shx=#2qre*x-0&nyq"
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # URL exacta de tu frontend
]
...
WSGI_APPLICATION = "sanitasoris.wsgi.application"
